...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendEmail(){
        ...
        String to="inbal.valigany@gmail.com";
        intent.putExtra(Intent.EXTRA_EMAIL,to);
        intent.putExtra(Intent.EXTRA_SUBJECT,"Set an Interview  ");
        intent.putExtra(Intent.EXTRA_TEXT,"Hi Inbal,");
        intent.setType("message/rfc822");
        Intent chooser=Intent.createChooser(intent,"Sent Email");
